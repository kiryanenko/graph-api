\hypertarget{class_graph_performance_test}{}\doxysection{Шаблон класса Graph\+Performance\+Test$<$ G $>$}
\label{class_graph_performance_test}\index{GraphPerformanceTest$<$ G $>$@{GraphPerformanceTest$<$ G $>$}}
...
size\+\_\+t {\bfseries avg\+\_\+iterations\+\_\+cnt} = 10
\item 
...
size\+\_\+t {\bfseries start\+\_\+vertices\+\_\+cnt} = 500
\item 
...
size\+\_\+t {\bfseries inc\+\_\+vertices\+\_\+value} = 500
\item 
...
size\+\_\+t {\bfseries edges\+\_\+per\+\_\+vertex} = 3
\end{DoxyCompactItemize}
