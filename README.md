...
## 1 Модель для оринтированного графа

Данная модель подходит для невзваешанных оринтированных графов. 
Она использует всего одну SPU структуру:
...
Данная модель подходит для ультраграфов и использует 2 структуры SPU:
